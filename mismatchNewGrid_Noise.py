...
pathRes = '/home/m206265/lalapps_work/mismatchNewGrid_Noise'
if noise == 0:
...
cmd+= ' --outputFstat='+pathRes+'/SNR_GridLoud_mism'+str(Mmetric)[2:]+'_'+str(iteration)+'_perfmatched.txt'
cmd+= ' --outputTiming='+pathRes+'/Timing_SNR_GridLoud_mism'+str(Mmetric)[2:]+'_perfmatched.txt'
