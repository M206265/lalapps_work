...
fBand = 20*dF #2*np.sqrt(0.4/gFav[0,0]) # SNR-reduction = 1 - mism; 
...
cmd+= ' --outputFstat='+pathRes+'/SNR_GridLoud_modif06_'+str(iteration)+'.txt'
cmd+= ' --outputTiming='+pathRes+'/Timing_SNR_GridLoud_modif06.txt'
